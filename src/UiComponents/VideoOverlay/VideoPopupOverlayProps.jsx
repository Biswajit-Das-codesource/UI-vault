...
const propsData = [
  {
    prop: "thumbnail",
    type: "string",
    default: '"https://wallpapercave.com/wp/wp4190777.jpg"',
    desc: "The background image used for the preview card before clicking play.",
  },
  {
    prop: "videoSrc",
    type: "string",
    default: '"https://www.youtube.com/embed/dQw4w9WgXcQ"',
    desc: "The YouTube or embed video URL shown in the modal popup.",
  },
];

const VideoPopupOverlayProps = () => {
  return (
          ...
          <tbody>
            {propsData.map(({ prop, type, default: def, desc }) => (
              ...
              >
                ...
                <td className="border border-gray-700 px-4 py-2 whitespace-nowrap">{type}</td>
                <td className="border border-gray-700 px-4 py-3 whitespace-nowrap">
                  <code className="bg-gray-800/60 px-2 py-1 rounded text-gray-300">{def}</code>
                </td>
...
export default VideoPopupOverlayProps;

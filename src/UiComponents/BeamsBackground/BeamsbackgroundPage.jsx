    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-400 mt-1">
          Flexible and beautiful beams background component for your UI.
        </p>

        <h2 className="text-xl font-bold mt-6">
          Theme : Obsidian Beams Background
        </h2>
        ...
        <div className="flex items-center justify-between bg-[#1a1a1a] border border-gray-700 text-green-400 px-5 py-4 text-sm rounded-2xl mt-4">
          ...
          >
            <span className="text-cyan-400">npx</span> ui-vault background-beams
          </code>
          <button
            onClick={() =>
              handleCopy("npx ui-vault background-beams", "beams-cli")
            }
...
export default BeamsbackgroundPage;

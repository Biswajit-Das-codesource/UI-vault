  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <p className="text-gray-300 mt-1">
        Beautiful animated testimonial cards for your UI.
      </p>

      {/* Neon Testimonial Section */}
      ...
      <div className="px-2 pt-2 pb-2 text-white">
      ...
      <div className="flex items-center justify-between bg-[#1a1a1a] border border-gray-700 text-green-400 px-5 py-4 text-sm rounded-2xl mt-4">
        ...
        >
          <span className="text-cyan-400">npx</span> ui-vault add testimonials
        </code>
        <button
          onClick={() =>
            handleCopy("npx ui-vault add testimonials", "neon-cli")
          }

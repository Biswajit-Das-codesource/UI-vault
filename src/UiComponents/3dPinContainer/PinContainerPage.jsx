...
import PinContainer from "./PinContainer"; // Your component

function PinContainerPage() {
  ...
  return (
    <div>
      ...
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-4xl font-bold">Pin Container</h1>
        <p className="text-gray-400 mt-1">
          A creative animated container component for pinning elements using Framer Motion.
        </p>
        ...
        {tab === "preview" && (
          <div className="relative mt-2 w-full h-[300px] sm:h-[400px] md:h-[500px] rounded-xl overflow-hidden flex items-center justify-center">
            <PinContainer />
          </div>
        )}
...
export default PinContainerPage;

...
import ObsidianBarchart from "./BlackBarchart";
import AuroraGradientBarchart from "./GradientBarchart";
...
function ObsidianBarchart() {
  return (
    <div className="bg-black text-white p-4 rounded-xl">
      <h1 className="text-purple-400">Obsidian Bars</h1>
      {/* ...chart code here... */}
    </div>
  );
}
export default ObsidianBarchart;`;

  const auroraCode = `import React from "react";
function AuroraGradientBarchart() {
  return (
    <div className="bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 text-white p-4 rounded-xl">
      <h1 className="font-bold">Aurora Gradient Barchart</h1>
      {/* ...chart code here... */}
    </div>
  );
}
export default AuroraGradientBarchart;`;

  return (
    <div>
      <Toaster richColors position="top-center" />
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold">Bar Charts</h1>
        <p className="text-gray-400 mt-1">
          Beautiful and flexible bar chart components for your UI.
        </p>

        {/* Obsidian Bars Theme */}
        <h2 className="text-xl font-bold mt-6">Theme : Obsidian Bars</h2>
        ...
        <h2 className="text-xl font-bold mt-6">Theme : Aurora Gradient</h2>
        <h1 className="text-2xl font-bold mb-2 mt-4">Installation</h1>
        <div className="flex border-b border-white/10 mt-7">
          <button className="px-4 py-2 text-white font-medium border-b-2 border-white">
            CLI

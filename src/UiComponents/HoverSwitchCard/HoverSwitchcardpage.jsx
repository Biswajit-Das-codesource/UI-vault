...
import HoverSwitchCard from "./HoverSwitchcard";

function Hoverswitchpage() {
  ...
  return (
    <div>
      ...
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold">Hoverswitch Card</h1>
        <p className="text-gray-400 mt-1">
          Flexible and beautiful hover switch card component for your UI.
        </p>
...
export default Hoverswitchpage;
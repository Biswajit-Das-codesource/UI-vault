...
export default GradientSignUpCard;`,
  ...
  const themes = [
    { id: "obsidian", label: "Neon Pulse", command: "npx ui-vault SocialCard-NeonPulse" },
    { id: "neon", label: "Frosted Glass", command: "npx ui-vault SocialCard-FrostedGlassSignUpCard" },
    { id: "hyper", label: "Gradient SignUp Card", command: "npx ui-vault SocialCard-GradientSignUpCard" },
  ];
    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-400 mt-1">
          Visually expressive card designs with copy & code previews for better user onboarding.
        </p>
          ...
          <div key={id} className="mt-10">
            ...
            <div className="flex items-center justify-between bg-[#1a1a1a] border border-gray-700 text-green-400 px-5 py-4 text-sm rounded-2xl mt-4">
              <code className="geist-mono overflow-x-auto text-sm" style={{ letterSpacing: "1px" }}>
                <span className="text-cyan-400">npx</span> {command.split("npx ")[1]}
              </code>
              <button
            ...
            {activeTab[id] === "preview" && (
              <div className="mt-3 bg-black rounded-xl">{renderCardComponent(id)}</div>
            )}

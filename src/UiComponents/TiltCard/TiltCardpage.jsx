  ...
  return (
    <div>
      ...
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold">Tilt Card</h1>
        <p className="text-gray-400 mt-1">
          Flexible and beautiful tilt card component for your UI.
        </p>
        ...
        <div className="flex items-center justify-between bg-[#1a1a1a] border border-gray-700 text-green-400 px-5 py-4 text-sm rounded-2xl mt-4">
          ...
          >
            <span className="text-cyan-400">npx</span> ui-vault add tiltcard
          </code>
          <button
            onClick={() => handleCopy("npx ui-vault add tiltcard", "tilt-cli")}

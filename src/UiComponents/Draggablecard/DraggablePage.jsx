...
import { DraggableCardGallery } from "./Draggablecard";
  ...
  return (
    <div>
      ...
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold">Draggable Gallery</h1>
        <p className="text-gray-400 mt-1">
          Interactive 3D-tilt draggable cards with image + text overlay.
        </p>

  ...
  return (
    <div>
      ...
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold">Cursor Effect</h1>
        <p className="text-gray-400 mt-1">
          Flexible and beautiful cursor effect component for your UI.
        </p>

...
function SilkBgPage() {
  ...
  const silkCode = `import React from "react";
import Silk from "./Silk";
  ...
  return (
    <div>
      ...
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-4xl font-bold">Silk Background</h1>
        <p className="text-gray-400 mt-1">
          A beautifully flowing shader background inspired by silk using
          Three.js and R3F.
        </p>

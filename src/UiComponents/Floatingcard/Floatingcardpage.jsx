  ...
  return (
    <div>
      ...
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold">Floating Card</h1>
        <p className="text-gray-400 mt-1">
          Flexible and beautiful floating card component for your UI.
        </p>

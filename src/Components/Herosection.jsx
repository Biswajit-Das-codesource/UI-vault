...
const Herosection = () => {
  ...
  return (
    <>
      ...
      <div>
         {!loadingDone && (
            <LogoLoader onComplete={() => setLoadingDone(true)} />
          )}
        {/* Hero Section */}
        <div className="relative z-10 bg-black text-white min-h-[90vh] px-4 py-2 flex flex-col lg:flex-row gap-8 overflow-hidden">
          ...
          >
            <motion.h1 className="text-5xl sm:text-6xl md:text-5xl font-extrabold leading-tight mt-8 sm:mt-1 text-white ">
              Design{" "}
            ...
            <motion.p className="mt-4 text-base sm:text-base text-gray-300 max-w-2xl">
            ...
            <motion.div className="mt-10 flex flex-col sm:flex-row gap-4 items-center sm:items-start justify-center sm:justify-start px-3 md:px-0 md:mt-8">
